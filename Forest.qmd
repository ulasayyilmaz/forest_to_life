---
title: Predicting Biodiversity by Change in Forest Mass
format: 
  html:
    page-layout: full
---
...
## METHODS ![](plots/Bangladesh_log.png){style="width: 25%; float: right; margin-left: 15px; margin-top: 10px; margin-bottom: 10px;"}
...
- **Model 3:** Regression Random Forest

![rf_pred](images/random_forest_training_prediction.png){style="width: 20%; float:right; margin-top: 10px; margin-bottom: 10px;"}

- **Model 4:** Classification Random Forest 

![rf_var_imp_bins](images/randomforest_var_iportance_categorical_bins.png){style="width: 20%; float:right; margin-top: 10px; margin-bottom: 10px;"}
