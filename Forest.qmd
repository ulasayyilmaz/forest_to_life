...
![Fig1. Countries List](images/list_countries.png){style="width: 20%; float: right; margin-left: 10px; margin-top: 10px;" fig-cap="Fig. 1: Country List"} 
...
![](plots/Bangladesh_log.png){style="width: 40%; float: right; margin-left: 15px; margin-top: 10px; margin-bottom: 10px;"}
...
**4.** We visualized the geospatial change of bird order concentrations across time. Our deforestation data don't unfortunately provide detail about the precise location of forest lost and gained, so it's hard to infer correlations between changes in bird number concentrations and changes in forests. 
  ...
  ![geobird](images/geo_pol_10_20.png){style="width: 80%; margin-top: 10px; margin-bottom: 10px;"}
...
- Talk about dataframe having 107 rows, and trying to train a RF with 500 trees etc. Data was too large, but then collapsed to have minimum rows. 
